...
// Data transport. The stacked appliance uses the internal UART through vendor
// StackFlow/llm_sys; CoreS3 HTTP polling is out of scope for this baseline.
// This is not a parallel /dev/ttyS1 bridge:
