...
2. `BATTERY`: battery-centric terms such as `Battery Charge`, `Runtime Remaining`, `Battery Voltage`, and `Battery Status` (`CHARGING`, `DISCHARGING`, `LOW`, `UNKNOWN`).
