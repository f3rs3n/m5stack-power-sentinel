...
def main() -> int:
    ...
    if require(main, [
        ...
        "POWER_SENTINEL_ALLOW_SHORT_DISPLAY_TIMEOUTS",
        "kDisplayStandbyRawMs < kDisplayStandbyDefaultMs",
        "kDisplayNoPayloadOffRawMs < kDisplayNoPayloadOffDefaultMs",
        "kDisplayDimRawBrightness == 0 ? kDisplayDimDefaultBrightness",
